...
import { generatePlanMarkdown, generateContextMarkdown, generateTasksMarkdown, } from '../utils/plan-generator.js';
...
export function devDocsCommand(program) {
    ...
    devDocsCmd
        ...
        try {
            ...
            for (const taskName of tasks) {
                ...
                const taskMetadata = (await readJson(taskJsonPath));
                ...
                if (taskMetadata.planPath && (await pathExists(taskMetadata.planPath))) {
                    try {
                        const plan = (await readJson(taskMetadata.planPath));
