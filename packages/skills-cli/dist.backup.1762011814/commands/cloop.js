...
import { generatePlanStart, validatePreviousPhase, validateQualityGate, extractPhaseNumber, } from '../utils/cloop-templates.js';
import { Logger } from '../utils/logger.js';
export function cloopCommand(program) {
    ...
    cloopCmd
        ...
        try {
            ...
            if (!(await pathExists(planStartPath))) {
                throw new Error(`Plan-start not found: ${planStartPath}. ` + `Run 'cloop start ${phase}' first.`);
            }
