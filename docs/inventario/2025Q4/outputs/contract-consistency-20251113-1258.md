INFO 2025-11-13T15:58:23.338Z Generando prompt optimizado para skill(s): Auditor de repositorio (read-only) (v2)

📝 PROMPT OPTIMIZADO:

repositorio: [Clarify] Verificar consistencia de contratos según plan mhxknb6e-bd6b0f3. [Plan] dev/active/auditoria-skills-core-2025q4/{plan.md,context.md,tasks.md}. [K] Contratos oficiales: docs/skills/ROUTER.md (210 líneas, v1.3, 2025-04-12), docs/skills/ROUTER-copy.md (posible duplicado, 2025-05-10), docs/skills/DAEMON.md (v1.2, 2025-04-20), docs/skills/SKILL-CONTRACT.md, docs/skills/NMLB.md. [K] Artefactos operativos: packages/router/src/config/router-contract.ts, packages/daemon/src/contracts/daemon-contract.ts, skills/guidelines/router-usage/SKILL.md, skills/guidelines/daemon-ops/SKILL.md. [U] Identificar divergencias y duplicados sin crear artefactos nuevos. [EVIDENCIA] docs/inventario/2025Q4/raw-files-packages.txt, outputs/discovery-20251113-filled.md. [PROPUESTA] Registrar hallazgos en hallazgos.json, acciones en acciones.md, métricas en metrics-2025-11-13.json.

---

meta:
id: "startkit-clarify-verificar-consistencia-de-contratos-seg-n-plan-mhxkn"
version: "1.0.0"
...
# PROMPT [Clarify] Verificar Consistencia De Contratos Según Plan Mhxknb6e-bd6b0f3. [Plan] Dev/active/auditoria-skills-core-2025q4/{plan.md,context.md,tasks.md}. [K] Contratos Oficiales: Docs/skills/ROUTER.md (210 Líneas, V1.3, 2025-04-12), Docs/skills/ROUTER-copy.md (posible Duplicado, 2025-05-10), Docs/skills/DAEMON.md (v1.2, 2025-04-20), Docs/skills/SKILL-CONTRACT.md, Docs/skills/NMLB.md. [K] Artefactos Operativos: Packages/router/src/config/router-contract.ts, Packages/daemon/src/contracts/daemon-contract.ts, Skills/guidelines/router-usage/SKILL.md, Skills/guidelines/daemon-ops/SKILL.md. [U] Identificar Divergencias Y Duplicados Sin Crear Artefactos Nuevos. [EVIDENCIA] Docs/inventario/2025Q4/raw-files-packages.txt, Outputs/discovery-20251113-filled.md. [PROPUESTA] Registrar Hallazgos En Hallazgos.json, Acciones En Acciones.md, Métricas En Metrics-2025-11-13.json.

## 🧭 Contexto y Fundamentos

- **Descripción**: [Clarify] Verificar consistencia de contratos según plan mhxknb6e-bd6b0f3. [Plan] dev/active/auditoria-skills-core-2025q4/{plan.md,context.md,tasks.md}. [K] Contratos oficiales: docs/skills/ROUTER.md (210 líneas, v1.3, 2025-04-12), docs/skills/ROUTER-copy.md (posible duplicado, 2025-05-10), docs/skills/DAEMON.md (v1.2, 2025-04-20), docs/skills/SKILL-CONTRACT.md, docs/skills/NMLB.md. [K] Artefactos operativos: packages/router/src/config/router-contract.ts, packages/daemon/src/contracts/daemon-contract.ts, skills/guidelines/router-usage/SKILL.md, skills/guidelines/daemon-ops/SKILL.md. [U] Identificar divergencias y duplicados sin crear artefactos nuevos. [EVIDENCIA] docs/inventario/2025Q4/raw-files-packages.txt, outputs/discovery-20251113-filled.md. [PROPUESTA] Registrar hallazgos en hallazgos.json, acciones en acciones.md, métricas en metrics-2025-11-13.json.
...
Audit 4D: 7.95/10
Tags: DOC, APPROVED
Summary: repositorio: [Clarify] Verificar consistencia de contratos según plan mhxknb6e-bd6b0f3. [Plan] dev/active/auditoria-skills-core-2025q4/{plan.md,context.md,tasks.md}...
